...
echo "▶️ Mise à jour de MainActivity (widget volume des notes)…"
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Son + gain initial des notes
        soundEngine = new SoundEngine(44_100);
        soundEngine.setNoteGain(0.5);

        // Listener du slider de volume des notes
...
echo "✅ MainActivity mis à jour (widget volume des notes ajouté)."
