...
echo "▶️ Mise à jour de MainActivity (zone centrale = tap-tempo)…"
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override protected void onPause() {
        super.onPause();
        // ne pas arrêter la boucle ici : permet de jouer écran éteint
    }
